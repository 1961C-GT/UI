import { IThemes, ThemeType } from "./types";

const MapStylesStandard: google.maps.MapTypeStyle[] = [];
const MapStylesSilver: google.maps.MapTypeStyle[] = [
  {
...
const MapStylesRetro: google.maps.MapTypeStyle[] = [
  {
    elementType: "geometry",
    stylers: [
      {
...
const MapStylesNight: google.maps.MapTypeStyle[] = [
  {
    elementType: "geometry",
    stylers: [
      {
...
const MapStylesAubergine: google.maps.MapTypeStyle[] = [
  {
    elementType: "geometry",
    stylers: [
      {
...
let Themes: IThemes = {
  ...
  [ThemeType.RETRO]: {
    appStyles: {},
    mapStyles: MapStylesRetro
  },
  [ThemeType.DARK]: {
    appStyles: {},
    mapStyles: MapStylesDark
  },
  [ThemeType.NIGHT]: {
    appStyles: {},
    mapStyles: MapStylesNight
  },
  [ThemeType.AUBERGINE]: {
    appStyles: {},
    mapStyles: MapStylesAubergine
  }
};
