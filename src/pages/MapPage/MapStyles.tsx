...
export const MapStylesRetro: google.maps.MapTypeStyle[] = [
  {
    elementType: "geometry",
    stylers: [
      {
...
export const MapStylesDark: google.maps.MapTypeStyle[] = [
  {
    elementType: "geometry",
    stylers: [
      {
...
export const MapStylesNight: google.maps.MapTypeStyle[] = [
  {
    elementType: "geometry",
    stylers: [
      {
...
export const MapStylesAubergine: google.maps.MapTypeStyle[] = [
  {
    elementType: "geometry",
    stylers: [
      {
